...
define('SUCCESS_CREATE_ACCOUNT','Votre compte a été créé avec succès !');
...
define('INFOS_COMPTE','Informations du compte');
define('MES_COMMANDES','Mes commandes');
define('LEGAL','Cadre légal');
define('SE_DECONNECTER','Se déconnecter');
...
// Page commande
define('COMMANDE_DU','Commande du');
define('A','à');
...
define('QUANTITE_INSUFFISANTE','Stocks insuffisants');
define('PAS_ASSEZ_DE_STOCK','n\'est pas disponible dans une quantité suffisante');
